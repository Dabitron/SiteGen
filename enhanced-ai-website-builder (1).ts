...
import { Layout, Sidebar, Image, Type, Box, List, Link, Menu, ChevronDown, Plus, Trash2, Eye, Code, Save, Upload, Settings, Undo, Redo, ZoomIn, ZoomOut, Move, RefreshCw } from 'lucide-react';
    ...
    <div className="flex h-screen bg-gray-100">
          ...
          <div className="w-1/2 bg-gray-100 border-l border-gray-300">
            <div className="h-full flex flex-col">
              <div className="bg-gray-200 p-2 flex justify-between items-center">
                ...
                <Button size="sm" variant="ghost" onClick={() => setIsPreviewVisible(false)}>
      ...
      <div className="h-16 bg-gray-800 flex items-center justify-between px-4">
        <div className="flex items-center space-x-2">
          <Tooltip>
            <TooltipTrigger asChild>
              <Button variant="ghost" onClick={() => setIsPreviewVisible(!isPreviewVisible)}>
                <Eye className="mr-2 h-4 w-4" /> {isPreviewVisible ? 'Hide' : 'Show'} Preview
              </Button>
            </TooltipTrigger>
            <TooltipContent>{isPreviewVisible ? 'Hide' : 'Show'